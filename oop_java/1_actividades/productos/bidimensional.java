/* * * *
 * U4 A2
 * Se solicita implementar dos arreglos; uno unidimensional tipo String, donde se guardar�n los nombres de los productos desde el teclado. 
 ...
 * precio menudeo y descuento. Al final el programa debe mostrar por separado, los datos de los nombres de productos y despu�s, 
...
public class bidimensional {
	...
	public static void main(String args[]) {	
        ...
        System.out.println("\nTabla de productos\n");
        System.out.printf("\t%15s \t->%12.8s\t | %5.8s\t | %s\n", "Producto", "Mayoreo", "Menudeo", "Descuento");	// funci�n de impresi�n con formato
        System.out.println("\t\t------------------------------------------------------------------");
